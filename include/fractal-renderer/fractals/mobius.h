...
public:
  ...
  Mobius(std::complex<double> a_, std::complex<double> b_,
         std::complex<double> c_, std::complex<double> d_)
      : a(a_), b(b_), c(c_), d(d_) {
  ...
  Mobius normalized() const {
    ...
    return Mobius(a / normalization_factor, b / normalization_factor,
                  c / normalization_factor, d / normalization_factor);
  }

  Mobius getInverse() const { return Mobius(d, -b, -c, a); }

  Mobius compose_mobius_transforms(const Mobius &other) const {
    return Mobius(a * other.a + b * other.c, a * other.b + b * other.d,
